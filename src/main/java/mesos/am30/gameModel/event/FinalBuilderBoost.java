...
public class FinalBuilderBoost implements IF_Event {
     ...
     * <br/><strong>Post:</strong> (\forall CharacterCard c; player.tribe(BUILDER).contains(c); player.parameters(PRESTIGE_POINTS) = \old(player.parameters(PRESTIGE_POINTS) + (c.getPrestigePoints() * (multiplier - 1)))
     *
