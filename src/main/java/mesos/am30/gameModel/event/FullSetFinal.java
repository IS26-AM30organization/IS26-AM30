...
public class FullSetFinal implements IF_Event {
     ...
     * <br/><strong>Post:</strong> player.parameters(PRESTIGE_POINTS) = \old(player.parameters(PRESTIGE_POINTS)) + (ppGain * (\min int nSets; nSets >= 0; (\forall Parameter p; ; player.tribe(p).size())))
     *
